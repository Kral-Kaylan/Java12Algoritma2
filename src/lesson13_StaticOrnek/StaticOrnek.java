...
//	//	number1+=1;  // static olmadığı için direk kullanamayız.Nesne oluşturmamız lazım.
//		number2+=1;
//		
//		System.out.println(number2);
//	}
...
//		
//		number2=5; // Number2 değeri static olduğu ve main metot da static olduğu için direk ulaşabiliyoruz.
//		
//		Static_Ornek00 nesne= new Static_Ornek00(); // Number1 static olmadığı için nesne oluşturup ulaşabildik.
//		nesne.number1=10;
//		
//		System.out.println(number2);
//		System.out.println(nesne.number1);
//		
//		nesne=new Static_Ornek00(); // yeni bir nesne oluşturduk
//		
//		System.out.println(number2);// 10
//		System.out.println(nesne.number1); //0 default değer atadı.
//		
//	}
//	
